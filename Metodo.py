...
def gauss_seidel():
  ...
  x = [0,0,0,0,0,0,0] #initial guess
   
  for i in xrange(20):
       x[0] = mat[0][0] + mat[0][1]*0  + mat[0][2]*x[1] + mat[0][3]*x[2] + mat[0][4]*x[3] + mat[0][5]*x[4] + mat[0][6]*x[5]
       x[1] = mat[1][0] + mat[1][1]*x[0] + mat[1][2]*0  + mat[1][3]*x[2] + mat[1][4]*x[3] + mat[1][5]*x[4] + mat[0][6]*x[5]
       x[2] = mat[2][0] + mat[2][1]*x[0] + mat[2][2]*x[1] + mat[2][3]*0  + mat[2][4]*x[3] + mat[2][5]*x[4] + mat[0][6]*x[5]
       x[3] = mat[3][0] + mat[3][1]*x[0] + mat[3][2]*x[1] + mat[3][3]*x[2]  + mat[3][4]*0 + mat[3][5]*x[4] + mat[0][6]*x[5]
       x[4] = mat[4][0] + mat[4][1]*x[0] + mat[4][2]*x[1] + mat[4][3]*x[2]  + mat[4][4]*x[3] + mat[4][5]*0 + mat[0][6]*x[5]
       x[5] = mat[5][0] + mat[5][1]*x[0] + mat[5][2]*x[1] + mat[5][3]*x[2]  + mat[5][4]*x[3] + mat[5][5]*x[4] + mat[0][6]*0
